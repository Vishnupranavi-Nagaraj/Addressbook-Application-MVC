...
//we are setting the values to the addlist page
    ...
    if(isset($_POST['savebutton'])) 
    {
        ...
        $insert=$add_obj->add_insert($name,$address,$city,$age,$country,$state,$_POST['savebutton']);
        if ($insert)
        { 
...
//Setting the values for a delete button in addresslist page
    public function delete()
    {
        if (isset($_POST['stud_delete_multiple_btn']))
        {
            ...
            $delte=$val->delete_db($extract_id,$_POST['stud_delete_multiple_btn']);
            if ($delte) {
...
//Setting the values to a updatelist page
    public function update($id)
    {
        ...
        {  
            ...
            $state = $_POST['state'];
            $val=new Addressmodel();
            $updateval=$val->update_button($name,$address,$city,$age,$country,$state,$id,$_POST['updatebutton']);
            if ($updateval)
            {
